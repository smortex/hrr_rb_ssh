RSpec.describe HrrRbSsh::Transport::KexAlgorithms::DiffieHellmanGroup18Sha512 do
  let(:name){ 'diffie-hellman-group18-sha512' }
  ...
  describe '::P' do
    it "has diffie hellman group 18's p" do
      expect(described_class::P).to eq dh_group18_p
    end
  end

  describe '::G' do
    it "has diffie hellman group 18's g" do
      expect(described_class::G).to eq dh_group18_g
    end
  end
